...
import com.example.musicmaster.databinding.FragmentGameOverBinding
...
class GameOverFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.texScore.setText(args.finalscore)

        binding.buttonPlayagain.setOnClickListener { view : View ->
